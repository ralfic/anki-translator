from PySide6.QtWidgets import QWidget, QVBoxLayout, QLineEdit, QPushButton, QLabel, QHBoxLayout, QTextEdit
...
class CardFields(QWidget):
    ...
    def setup_ui(self):
        ...
        self.source_field.textChanged.connect(lambda text: text == "" and self.clear_fields())
